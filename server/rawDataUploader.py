...
#here we will be trying to convert the objects in such a way that they are easily searchable and also original...
#may prove to be difficult...
#json is easy but hard to search with.... but will be ok if all the searching is being done in reverse chronological order?
#sql is already set ip but will kinda suck if anything about the program changes... maybe do sql and then not try to clean it until front end?
